...
**Generation status:** Python **FastAPI** and **Django** REST APIs (Simple and Modular Monolith) are generated as runnable projects. Other frameworks remain catalog options or future work until their generators exist.
